	...
	#render(shadow) {
		...
		<div class="post-container">
			<div class="post-image">
				<img src="../src/assets/images/logo.png" alt="Publicación">
				<div class="controls">
			...
			<div class="post-details">
				...
				<div class="comments">
					<div class="comment">
						<img src="../src/assets/images/logo.png" alt="PabloOne" class="comment-avatar">
						<span>PabloOne</span>
					</div>
					<div class="comment">
						<img src="../src/assets/images/logo.png" alt="PabloTwo" class="comment-avatar">
						<span>PabloTwo</span>
						<img src="../src/assets/images/logo.png" alt="Dibujo" class="comment-image">
					</div>
				</div>
